...
public class DemoService_ServiceLocator extends org.apache.axis.client.Service implements test.DemoService_Service {
    ...
    private java.lang.String DemoServiceImplPort_address = "http://localhost:9001/mk-webservice-demo/demo/api";
    ...
    public test.DemoService_PortType getDemoServiceImplPort() throws javax.xml.rpc.ServiceException {
    ...
    public test.DemoService_PortType getDemoServiceImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            test.DemoServiceSoapBindingStub _stub = new test.DemoServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (test.DemoService_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                test.DemoServiceSoapBindingStub _stub = new test.DemoServiceSoapBindingStub(new java.net.URL(DemoServiceImplPort_address), this);
                _stub.setPortName(getDemoServiceImplPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.mq.primeton.com", "DemoService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.mq.primeton.com", "DemoServiceImplPort"));
        }
